    ...
    <List
      ...
      searchBarAccessory={
        <List.Dropdown
          tooltip="Sort by"
          value={sortBy}
          onChange={(value) => setSortBy(value as SortCriteria)}
        >
            ...
            case "input-price":
              if (model.price_per_input_token) {
                accessories.push({
                  ...
                  tooltip: "Price per token included in the request/message sent to the API, represented as USD per million Tokens.",
                });
              }
              break;
            case "output-price":
              if (model.price_per_output_token) {
                accessories.push({
                  ...
                  tooltip: "Price per token generated by the model (received from the API), represented as USD per million Tokens",
                });
              }
              break;
            case "context-window":
              if (model.context !== null) {
                accessories.push({
                  ...
                  tooltip: "Maximum number of combined input & output tokens. Output tokens commonly have a significantly lower limit",
                });
              }
              break;
            case "throughput":
